...
public class Account implements Comparable<Account> {
	...
	/**
	 * Constructs a new Account for a NON-TUTOR STUDENT with the given email,
	 * password, and name.
	 *
	...
	public String toString() {
		return String.format("%s%n%s%n%s%n%s%n%s%n%d", this.email, this.password, this.name, this.tutor, this.id,
				this.studyTime);
	}
